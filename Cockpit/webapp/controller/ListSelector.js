sap.ui.define([
	...
	return BaseObject.extend("cockpit.Cockpit.controller.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias cockpit.Cockpit.controller.ListSelector
		 */
		...
		constructor: function () {
			...
			this.oWhenListLoadingIsDone = new Promise(function (fnResolve, fnReject) {
				...
				this._oWhenListHasBeenSet
					.then(function (oList) {
						oList.getBinding("rows").attachEventOnce("dataReceived",
							function () {
								if (this._oList.getRows().length) {
									fnResolve({
										list: oList
									});
								} else {
