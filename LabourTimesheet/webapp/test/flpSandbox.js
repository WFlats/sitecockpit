		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Labour Timesheet",
									"targetURL": "#LabourTimesheet-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"LabourTimesheet-display": {
								"semanticObject": "LabourTimesheet",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=labour.timesheet.LabourTimesheet",
									"url": sap.ui.require.toUrl("labour/timesheet/LabourTimesheet")
								}
							}
						}
					}
