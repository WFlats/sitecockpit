sap.ui.define([
	...
	return BaseController.extend("recipe.RecipeEditor.controller.Master", {
		...
		onUpdateFinished: function (oEvent) {
			...
			if (!this.getModel("userModel").getProperty("/email")) {
				this.getUserInfo("RecipeEditor", "Recipe Manager", "");
			}
		},
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "recipe.RecipeEditor.view.ViewSettingsDialog",
					controller: this
		...
		onConfirmViewSettingsDialog: function (oEvent) {
			...
			aFilterItems.forEach(function (oItem) {
				switch (oItem.getKey()) {
				case "Filter1":
					aFilters.push(new Filter("productivity", FilterOperator.LE, 100));
					break;
				case "Filter2":
					aFilters.push(new Filter("productivity", FilterOperator.GT, 100));
					break;
				default:
					break;
				}
		...
		_showDetail: function (oItem) {
			var bReplace = !Device.system.phone,
				sRecipeID = oItem.getBindingContext().getProperty("ID");
			// set the layout property of FCL control to show two columns
			this.getModel("appView").setProperty("/layout", "TwoColumnsMidExpanded");
			this.getModel("appView").setProperty("/selectedRecipeID", sRecipeID);
