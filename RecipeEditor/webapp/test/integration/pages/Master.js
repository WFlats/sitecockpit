		...
		onTheMasterPage : {
			...
			actions : {
				...
				iSortTheListOnUnitNumber : function () {
					return this.iChooseASorter("sortButton", "Sort By <productivity>");
				},

				iFilterTheListOnUnitNumber : function () {
					return this.iMakeASelection("filterButton", "<productivity>", "<100 <UoM_ID>");
				},

				iGroupTheList : function () {
					return this.iChooseASorter("groupButton", "<productivity> Group");
				},
						...
						success : function (aEntityData) {
							this.waitFor({
								...
								success : function (oList) {
									...
									oCurrentItem.bindingPath = "/" + oList.getModel().createKey("Recipes", {
										ID : sCurrentId
									});
			...
			assertions : {
				...
				theListHeaderDisplaysZeroHits : function () {
					return this.waitFor({
						...
						id: "masterPageTitle",
						autoWait: false,
						matchers: new PropertyStrictEquals({name : "text", value : "<Recipes> (0)"}),
						success: function () {
				...
				theListShouldBeFilteredOnUnitNumber : function () {
					return this.theListShouldBeFilteredOnFieldUsingComparator("productivity", 100);
				},


				theListShouldBeSortedAscendingOnUnitNumber : function () {
					return this.theListShouldBeSortedAscendingOnField("productivity");
				},
				...
				theListShouldHaveAllEntries : function () {
					...
					// retrieve all Recipes to be able to check for the total amount
					...
					return this.waitFor({
						...
						success : function (oList) {
							...
							this.waitFor({
								id : "masterPageTitle",
								viewName : sViewName,
								matchers : new PropertyStrictEquals({name : "text", value : "<Recipes> (" + iExpectedLength + ")"}),
								success : function () {
