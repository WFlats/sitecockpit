		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Site Recorder",
									"targetURL": "#SiteRecorder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SiteRecorder-display": {
								"semanticObject": "SiteRecorder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=site.recorder.SiteRecorder",
									"url": sap.ui.require.toUrl("site/recorder/SiteRecorder")
								}
							}
						}
					}
