sap.ui.define([
	...
	return Controller.extend("project.data.ProjectData.controller.BaseController", {
		/**
		...
		adjustUTC: function (oDate) {
			// adds the time zone offset to the hours; result is same time as UTC
			if (oDate) {
				var oAdjustedDate = new Date(Date.UTC(oDate.getFullYear(), oDate.getMonth(), oDate.getDate(), oDate.getHours(), oDate.getMinutes(),
					oDate.getSeconds()));
				return oAdjustedDate;
			} else {
				return undefined;
			}
		},
