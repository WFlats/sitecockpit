sap.ui.define([
	"sap/ui/test/Opa5",
	"project/data/ProjectData/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel",
	"sap/ui/core/routing/HashChanger",
	"project/data/ProjectData/test/flpSandbox",
	"sap/ui/fl/FakeLrepConnectorLocalStorage"
], function(Opa5, mockserver, ODataModel, HashChanger, flpSandbox, FakeLrepConnectorLocalStorage) {
	"use strict";

	return Opa5.extend("project.data.ProjectData.test.integration.arrangements.Startup", {
